...
#ifndef MD4QT_MD_INLINE_CODE_PARSER_H_INCLUDED
#define MD4QT_MD_INLINE_CODE_PARSER_H_INCLUDED
...
/*!
 * \class MD::InlineCodeParser
 * \inmodule md4qt
 * \inheaderfile md4qt/inline_code_parser.h
 *
 * \brief Inline code parser.
 *
 * Inline code parser.
 */
...
#endif // MD4QT_MD_INLINE_CODE_PARSER_H_INCLUDED
